...
def signup_command():
    ...
    def wm_geometry(self, newGeometry):
...
label=Label(root, image=img, border=0, bg='white').place( x = 0 ,y = 0)
...
Button(frame,width=39,pady=7,text='Sign in',bg='blue',fg='white',border=0,command=signin).place(x=35,y=230)
label=Label(frame,text="Don't have an account?",fg='black',bg='white',font=('Microsoft Yahei UI Light',9))
label.place(x=90,y=280)

signup=Button(frame,width=6,text='Sign up',border=0,bg='white',cursor='hand2',fg='blue',command=signup_command)
